		...
		<nav id="sidebar">
			<div class="sidebar-header">
				<h1 class="site-title">
					...
					<div class="buttonsign">
						<button class="custom-btn btn-16" style = "float">로그인</button>
			...
			<div class="sidebar-footer">
				<p class="social-icons">
					<a target="_blank" href="#"><i class="fa fa-youtube"></i></a> <a
						target="_blank" href="#"><i class="fa fa-soundcloud"></i></a> <a
			...
			<div class="card-columns">
				<div class="card">
					<img class="card-img-top img-fluid"
						src="https://i.ytimg.com/vi/iFNpUl9cfKg/sddefault.jpg"
						alt="Card image cap">
					<div class="card-block">
						<h2 class="card-title">
							<a href="https://youtu.be/iFNpUl9cfKg&t=158s">Part.09
								반복문(for문 기초)</a>
						</h2>
				...
				<div class="card">
					<img class="card-img-top img-fluid"
						src="https://i.ytimg.com/vi/1t9nKrsdkdw/sddefault.jpg"
						alt="Card image cap">
					<div class="card-block">
						<h2 class="card-title">
							<a href="https://youtu.be/1t9nKrsdkdw">코딩 분야 소개와 가장 먼저 공부해야 할
								것과 공부 순서</a>
						</h2>
						<p class="card-text">요약</p>
						<p class="card-text">
				...
				<div class="card card-inverse card-primary p-3 text-center">
					<blockquote class="card-blockquote">
						...
						<footer>
							<small> Someone famous in <cite title="Source Title" R.
								D. Hitchcock</cite>
							</small>
						</footer>
					</blockquote>
				...
				<div class="card">
					<img class="card-img-top img-fluid"
						src="https://i.ytimg.com/vi/SGGebq48h3Y/sddefault.jpg"
						alt="Card image cap">

					<div class="card-block">
						<h2 class="card-title">
							<a href="https://youtu.be/SGGebq48h3Y">백엔드 서버 클릭 몇번으로 무료 배포하는
								방법</a>
						</h2>
				...
				<div class="card p-3 text-right">
					<blockquote class="card-blockquote">
						<img class="card-img img-fluid"
							src="https://i.ytimg.com/vi/j8Nj7NYqYB4/sddefault.jpg"
							alt="Card image">

						<h2 class="card-title">
							<a href="https://youtu.be/SGGebq48h3Y">인공지능 고구마 판별</a>
						</h2>
						<p>요약</p>
						<footer>
							<small class="text-muted"> Someone famous in <cite
				...
				<div class="card">
					<div class="card-block">
						...
						<p class="card-text"></p>
						<p class="card-text">
							<small class="text-muted">좋댓구알</small>
						</p>
					</div>
				</div>
			</div>
